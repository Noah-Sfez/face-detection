...
async function setupCamera() {
    ...
    await faceapi.nets.tinyFaceDetector
        .loadFromUri("/models")
        .then(() => console.log("Tiny Face Detector loaded"));
    await faceapi.nets.faceLandmark68Net
        .loadFromUri("/models")
        .then(() => console.log("Face Landmark 68 Net loaded"));
    await faceapi.nets.faceRecognitionNet
        .loadFromUri("/models")
        .then(() => console.log("Face Recognition Net loaded"));
    await faceapi.nets.faceExpressionNet
        .loadFromUri("/models")
        .then(() => console.log("Face Expression Net loaded"));
